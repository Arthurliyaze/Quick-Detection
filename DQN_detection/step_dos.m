function [T_whiten, x_k1_predict, Mk1, ak1, bk1] = step_dos(current_step, attack_time, idx_inj, attack_mag, x_k_predict, Mk, ak, bk)
%STEP_DOS This function uses Israel and Samrat's code to calculate the statistic of Rao test
